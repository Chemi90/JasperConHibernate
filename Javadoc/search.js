    ...
    _renderMenu: function(ul, items) {
        ...
        $.each(items, function(index, item) {
            if (item.category && item.category !== currentCategory) {
                ul.append("<li class='controllers-autocomplete-category'>" + categories[item.category] + "</li>");
        ...
        ul.append("<li class='controllers-static-link'><a href='" + pathtoroot + "search.html?q="
